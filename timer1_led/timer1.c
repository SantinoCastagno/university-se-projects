...
#define CONF_CONTROL_REG_A_FPWM 0b10000010; // | [WGM11|WGM10] fast PWM
...
#define TIMER1_0CR1AH_MIDPOS 0x07
#define TIMER1_0CR1AL_MIDPOS 0xd0
...
int timer1_init()
{
        ...
        timer->out_compare_reg_ah = TIMER1_0CR1AH_MIDPOS;
        timer->out_compare_reg_al = TIMER1_0CR1AL_MIDPOS;
